...
| Records (structural typing, keyword fields) | `03-type-system/record-types.md` |
| Variants (sum types, nominal) | `03-type-system/variant-types.md` |
| Generics, polymorphism, variance | `03-type-system/generic-types.md` |
| Subtyping, width subtyping, invariance | `03-type-system/subtyping.md` |
| Type aliases | `03-type-system/type-aliases.md` |
| Type error messages, format | `03-type-system/error-reporting.md` |
| Error codes (VFxxxx reference) | `../errors/README.md` (auto-generated) |
...
| Understand a type error? | `../errors/README.md` → `../errors/typechecker.md` |
| Fix error VFxxxx? | `../errors/README.md` (search by code) |
...
| Width/structural subtyping? | `03-type-system/subtyping.md`, `record-types.md` |
| Nominal typing? | `03-type-system/variant-types.md` |
| Type parameter variance/invariance? | `03-type-system/subtyping.md`, `generic-types.md` |
| Exhaustiveness checking? | `05-pattern-matching/exhaustiveness.md` |
| Semicolon requirements? | `02-lexical-structure/basic-structure.md` |
| Evaluation order? | `04-expressions/evaluation-order.md` |
| Desugaring? | `12-compilation/desugaring.md` |
| Error VFxxxx (any code)? | `../errors/README.md` (auto-generated reference) |
| Error recovery strategy? | `03-type-system/error-reporting.md` |
...
| Use keywords as field names? | `03-type-system/record-types.md`, `04-expressions/data-literals.md` (yes - explicit syntax only) |
...
| This cause a type error? | `../errors/typechecker.md` → relevant type file |
| Module import fail? | `08-modules.md`, `../errors/modules.md` |
| This error code mean? | `../errors/README.md` (VFxxxx lookup) |
...
4. `03-type-system/generic-types.md` (polymorphism, variance)
5. `03-type-system/subtyping.md` (width subtyping, invariance, inference integration)
6. `03-type-system/error-reporting.md` + `../errors/typechecker.md` (error messages, VF4xxx codes)
...
├── 03-type-system/                 # Hindley-Milner + extensions (12 files)
...
| Record width subtyping (extra fields OK) | `03-type-system/record-types.md`, `subtyping.md` |
| Variant nominal typing (exact names) | `03-type-system/variant-types.md` |
| Type parameters are **invariant** | `03-type-system/subtyping.md`, `generic-types.md` |
| Function types require exact match (no variance) | `03-type-system/record-types.md`, `subtyping.md` |
