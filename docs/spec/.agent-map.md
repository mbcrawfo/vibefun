...
| Error codes (VF0001, etc.) | `03-type-system/error-catalog.md` |
...
| Understand a type error? | `03-type-system/error-catalog.md` → `error-reporting.md` |
| Fix error VF0001? | `03-type-system/error-catalog.md` (search by code) |
...
| Error VF0001, VF0050, etc.? | `03-type-system/error-catalog.md` |
...
| This cause a type error? | `03-type-system/error-catalog.md` → relevant type file |
| Module import fail? | `08-modules.md` (resolution algorithm, circular deps) |
| This error code mean? | `03-type-system/error-catalog.md` (VF0001-VF0249) |
...
6. `03-type-system/error-reporting.md` + `error-catalog.md` (error messages, codes VF0001-VF0249)
