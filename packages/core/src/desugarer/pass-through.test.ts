...
describe("Mutable References - Operators", () => {
    it("should desugar reference assignment (RefAssign)", () => {
        ...
        expect((result as CoreBinOp).op).toBe("RefAssign");
        expect((result as CoreBinOp).left.kind).toBe("CoreVar");
        expect((result as CoreBinOp).right.kind).toBe("CoreIntLit");
    });
    ...
    it("should desugar dereference (Deref)", () => {
        ...
        expect((result as CoreUnaryOp).expr.kind).toBe("CoreVar");
    });
    ...
    it("should desugar complex ref assignment", () => {
        ...
        expect(result.kind).toBe("CoreBinOp");
        expect((result as CoreBinOp).op).toBe("RefAssign");
        expect((result as CoreBinOp).right.kind).toBe("CoreBinOp");
        expect(((result as CoreBinOp).right as CoreBinOp).op).toBe("Add");
    });
});
...
describe("Type Annotations", () => {
    it("should preserve type annotation and desugar expression", () => {
        ...
        expect((result as CoreTypeAnnotation).typeExpr.kind).toBe("CoreTypeConst");
    });
    ...
    it("should desugar complex expression with type annotation", () => {
        ...
        expect(result.kind).toBe("CoreTypeAnnotation");
        expect((result as CoreTypeAnnotation).expr.kind).toBe("CoreBinOp");
    });
    ...
    it("should desugar lambda with type annotation", () => {
        ...
        expect((result as CoreTypeAnnotation).expr.kind).toBe("CoreLambda");
    });
});
...
describe("Unsafe Blocks", () => {
    ...
    it("should desugar complex expression inside unsafe", () => {
        ...
        expect(result.kind).toBe("CoreUnsafe");
        expect((result as CoreUnsafe).expr.kind).toBe("CoreBinOp");
    });
...
describe("External Blocks", () => {
    it("should expand external block with single value", () => {
        ...
        const resultArray = result as CoreDeclaration[];
        expect(resultArray.length).toBe(1);
        expect(resultArray[0]!.kind).toBe("CoreExternalDecl");
        expect((resultArray[0]! as CoreExternalDecl).name).toBe("log");
        expect((resultArray[0]! as CoreExternalDecl).from).toBe("console");
    });
    ...
    it("should expand external block with multiple values", () => {
        ...
        expect((resultArray[0]! as CoreExternalDecl).name).toBe("log");
        expect((resultArray[1]! as CoreExternalDecl).name).toBe("warn");
    });
    ...
    it("should expand external block with types", () => {
        ...
        const resultArray = result as CoreDeclaration[];
        expect(resultArray.length).toBe(2);
        expect(resultArray[0]!.kind).toBe("CoreExternalTypeDecl");
        expect(resultArray[1]!.kind).toBe("CoreExternalTypeDecl");
        expect((resultArray[0]! as CoreExternalTypeDecl).exported).toBe(true);
        expect((resultArray[1]! as CoreExternalTypeDecl).exported).toBe(true);
    });
    ...
    it("should expand external block with mixed values and types", () => {
        ...
        expect(resultArray[0]!.kind).toBe("CoreExternalDecl");
        expect(resultArray[1]!.kind).toBe("CoreExternalTypeDecl");
        expect(resultArray[2]!.kind).toBe("CoreExternalDecl");
    });
    ...
    it("should preserve exported flag from block to all items", () => {
        ...
        const resultArray = result as CoreDeclaration[];
        expect((resultArray[0]! as CoreExternalDecl).exported).toBe(true);
    });
});
...
describe("Pass-Through - Integration", () => {
    it("should handle mutable let in module", () => {
        ...
        expect((result.declarations[0]! as CoreLetDecl).mutable).toBe(true);
    });
