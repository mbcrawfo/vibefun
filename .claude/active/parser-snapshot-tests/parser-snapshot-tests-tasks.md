...
### Directory Structure
- [ ] Create `packages/core/src/parser/snapshot-tests/` directory
- [ ] Create `packages/core/src/parser/snapshot-tests/fixtures/` directory
- [ ] Create `packages/core/src/parser/snapshot-tests/__snapshots__/` directory (will be auto-generated by vitest)

### Test Runner
- [ ] Create `snapshot-tests.test.ts` with basic structure
- [ ] Implement `parseSnapshot()` helper function to load and parse .vf files
- [ ] Add test suite structure for all 8 categories
- [ ] Verify test runner works with a simple fixture
...
- [ ] Add test case for declarations.vf
- [ ] Add test case for expressions.vf
- [ ] Add test case for patterns.vf
- [ ] Add test case for functions.vf
- [ ] Add test case for data-structures.vf
- [ ] Add test case for control-flow.vf
- [ ] Add test case for modules.vf
- [ ] Add test case for real-world.vf

### Generate Snapshots
- [ ] Run `npm test` to generate initial snapshots
- [ ] Review all generated snapshots for correctness
- [ ] Verify AST structure matches expectations
- [ ] Verify snapshots are formatted and readable
